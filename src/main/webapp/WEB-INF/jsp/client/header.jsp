...
<a href="/client/login.jsp">登录</a>
<a href="/client/regist.jsp">注册</a>
</c:if>
<c:if test="${sessionScope.user!=null}">
        ...
        <div id=qh_con0 style="DISPLAY: block">
          <UL>
           	<c:forEach items="${sessionScope.cs}" var="c">
	            <LI><A href="/servlet/ClientServlet?operation=showCategoryBooks&categoryId=${c.id}"><SPAN>${c.name}</SPAN></A></LI>
